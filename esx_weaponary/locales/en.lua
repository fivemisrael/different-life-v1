Locales['en'] = {
  ...
  ['weaponary_wear'] = 'Weaponary Outfit',
  ...
  -- Armory
  ['remove_object'] = 'משוך חפץ',
  ['deposit_object'] = 'אחסן חפץ',
  ['get_weapon'] = 'משוך נשק מהנשקייה',
  ['get_stock'] = 'משוך',
  ['put_stock'] = 'אחסן',
  ['put_weapon'] = 'אחסן נשק בנשקייה',
  ['buy_weapons'] = 'קנה נשקים',
  ['buy_weapon_menu'] = 'קנה נשקים',
  ['armory'] = 'נשקייה',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Weaponary~s~',
  -- Vehicle interaction
