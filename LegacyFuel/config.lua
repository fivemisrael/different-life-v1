...
-- Class multipliers. If you want SUVs to use less fuel, you can change it to anything under 0.6, and vise versa.
Config.Classes = {
	[0] = 0.6, -- Compacts
	[1] = 0.6, -- Sedans
	[2] = 0.6, -- SUVs
...
Config.GasStations = {
	...
	vector3(-526.019, -1210.603, 18.184),
