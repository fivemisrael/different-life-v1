Locales['en'] = {
  -- חדר הלבשה
  ['cloakroom'] = 'חדר הלבשה',
  ['citizen_wear'] = 'חליפת אזרח',
  ['police_wear'] = 'חליפת משטרת ישראל',
  ['gilet_wear'] = 'חליפת תנועה',
  ['bullet_wear'] = 'שכפץ משטרתי',
  ['no_outfit'] = 'there\'s no uniform that fits you!',
  ['open_cloackroom'] = 'press ~INPUT_CONTEXT~ to change ~y~clothes~s~.',
  -- נשקייה
  ['remove_object'] = 'משוך פריט',
  ['deposit_object'] = 'הכנס פריט',
  ['get_weapon'] = 'משוך פריט מהנשקייה',
  ['put_weapon'] = 'אחסן פריט',
  ['buy_weapons'] = 'קנה נשקים',
  ['armory'] = 'נשקייה',
  ['open_armory'] = 'press ~INPUT_CONTEXT~ to access the ~y~Armory~s~.',
  ['open_storage'] = 'press ~INPUT_CONTEXT~ to access the ~y~confiscation Room~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'חינם',
  ['armory_item'] = '$%s',
  ['armory_weapontitle'] = 'נשקייה - קנה נשק',
  ['armory_componenttitle'] = 'נשקייה - תוספות לנשק',
  ...
  ['get_weapon_menu'] = 'נשקייה - משוך נשק',
  ['put_weapon_menu'] = 'נשקייה - אחסן נשק',
  ['communityService'] = 'עבודות שירות',
  ['jailmenu'] = 'תפריט כליאה',
  -- רכבים
  ['vehicle_menu'] = 'רכב',
  ...
  ['garage_title'] = 'פעולות רכב',
  ['garage_stored'] = 'מאוחסן',
  ['garage_notstored'] = 'לא במוסך',
  ...
  ['garage_storeditem'] = 'פתיחת מוסך',
  ['garage_storeitem'] = 'אחסן רכב במוסך',
  ['garage_buyitem'] = 'חנות רכבים משטרתיים',
  ...
  ['shop_item'] = '$%s',
  ['vehicleshop_title'] = 'חנות רכבים משטרתיים',
  ...
  -- תפריט פעולות
  ['citizen_interaction'] = 'תפריט אזרח',
  ['vehicle_interaction'] = 'תפריט רכבים',
  ['object_spawner'] = 'זימון חפץ משטרתי',

  ['id_card'] = 'תעודת זהות',
  ['search'] = 'חיפוש',
  ['handcuff'] = 'אזיקה',
  ['uncuff'] = 'שיחרור אזיקים',
  ['drag'] = 'ליווי',
  ['put_in_vehicle'] = 'לשים ברכב',
  ['out_the_vehicle'] = 'למשוך מהרכב',
  ['fine'] = 'קנוס שחקן',
  ['Community Service'] = 'תן עבודות שירות לשחקן',
  ['unpaid_bills'] = 'מיון תשלומים',
  ['license_check'] = 'מיון רשיונות',
  ['license_revoke'] = 'שלילת רישיון',
  ...
  -- תפריט רכב אינטראקטיבי
  ['vehicle_info'] = 'מידע על הרכב',
  ['pick_lock'] = 'פריצה לרכב',
  ...
  ['search_database'] = 'חיפוש הרכב במאגר הנתונים',
  ['search_database_title'] = 'חיפוש הרכב - עם מספר הרישוי',
  ...
  -- תפריט תנועה אינטראקטיבי
  ['traffic_interaction'] = 'תפריט תנועה אינטראקטיבי',
  ['cone'] = 'קונוס',
  ['barrier'] = 'מחסום',
  ['spikestrips'] = 'קוצנים',
  ['box'] = 'קופסה',
  ['cash'] = 'קופסה מלאה בכסף',
  -- תפריט תעודת זהות
  ['name'] = 'name: %s',
  ['job'] = 'job: %s',
  ['sex'] = 'sex: %s',
