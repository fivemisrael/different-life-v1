...
function GetIndexedPlayerList()
	...
	for k,v in ipairs(GetActivePlayers()) do
		players[tostring(GetPlayerServerId(v))]=GetPlayerName(v)..(v==PlayerId() and " (עצמך)" or "")
	end
...
AddEventHandler("el_bwh:receiveWarn",function(sender,message)
	TriggerEvent("chat:addMessage",{color={255,255,0},multiline=true,args={"Different Life Roleplay Administration","קיבלת אזהרה"..(sender~="" and " -מ "..sender or "").."!\n-> "..message}})
	Citizen.CreateThread(function()
...
TriggerEvent('chat:addSuggestion', '/goback', 'Finish assist and tp back',{})
