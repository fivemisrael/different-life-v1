...
function OpenDjMenu()
	local elements = {}
	table.insert(elements, {label = 'נגן מוזיקה', value = 'play_music'})
	table.insert(elements, {label = 'עצור מוזיקה', value = 'pause_music'})
	table.insert(elements, {label = 'כבה מוזיקה', value = 'stop_music'})
	table.insert(elements, {label = ':פלייליסט', value = 'playlist'})
