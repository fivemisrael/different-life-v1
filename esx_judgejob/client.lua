...
AddEventHandler('esx:playerLoaded', function(xPlayer)
  ...
  Citizen.CreateThread(function()
  	while true do
  		...
  		if(PlayerData.job ~= nil and PlayerData.job.name == "judge") then
  ...
  if(PlayerData.job.grade_name == "boss" and PlayerData.job.name == "judge") then
  	createSocietyMenu(bossUI.x,bossUI.y,bossUI.z,"judge", "Judge")
  end
end)
...
function openTakeService()
  ...
  local elements = {
    ...
    {label = "judge wear", value = 'judge_wear'}
  }
  ...
  ESX.UI.Menu.CloseAll()
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'judge_wear' then
