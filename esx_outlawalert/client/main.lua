...
Citizen.CreateThread(function()
	while true do
		...
		elseif IsPedShooting(playerPed) and not IsPedCurrentWeaponSilenced(playerPed) and Config.GunshotAlert then
			...
			if Weapon ~= 883325847 and Weapon ~= 101631238 and Weapon ~= 600439132 and Weapon ~= 126349499 and Weapon ~= 1233104067 and Weapon ~= 1198879012 and Weapon ~= 911657153 then
