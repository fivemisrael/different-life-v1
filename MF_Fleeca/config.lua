...
fleeca.Version = '1.0.14'

fleeca.PoliceJobName = "police"
fleeca.MinPoliceOnline = 4

fleeca.InteractKey = "E"
fleeca.ResetTimer = 240 -- minutes?
fleeca.InteractTimer = 10

fleeca.LoadDist = 50.0
fleeca.ActionDist = 1.0
