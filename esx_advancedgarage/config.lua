...
Config.CarPoundPrice      = 15 -- Car Pound Price.
Config.BoatPoundPrice     = 0 -- Boat Pound Price.
...
Config.PolicePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 454.88, y = -1023.16, z = 27.44 },
		SpawnPoint = { x = 451.53, y = -1023.28, z = 28.23 }
	}
}

Config.AmbulancePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 361.55, y = -585.22, z = 72.77 },
		SpawnPoint = { x = 350.88, y = -587.79, z = 74.55, h = 90 }
	}
}
...
Config.CarGarages = {
	...
	Garage_Stadium = {
		GaragePoint = { x= -73.53, y=-2004.28, z=17.28 },
		SpawnPoint = { x=-73.48, y=-2018.14, z=17.02, h = 76.55 },
		DeletePoint = { x=-72.11, y=-1996.99, z=17.02 }
	},
	Garage_LSPD = {
		GaragePoint = {},
		SpawnPoint = {},
	...
	Garage_Market = {
		GaragePoint = { x= 362.21, y=298.21, z=103.88 },
		SpawnPoint = { x=383.95, y=274.73, z=102.01, h = 340.93 },
		DeletePoint = { x=363.53, y=281.3, z=102.32 }
	},
	Garage_Comedy = {
		GaragePoint = { x= -340.48, y=267.07, z=84.68 },
		SpawnPoint = { x=-344.38, y=288.51, z=84.22, h = 340.93 },
		DeletePoint = { x=363.53, y=281.3, z=102.32 }
	},
	Garage_HawickBank = {
		GaragePoint = { x= 275.82, y=-344.94, z=45.17 },
		SpawnPoint = { x=292.48, y=-334.69, z=43.92, h = 158.85 },
		DeletePoint = { x=274.72, y=-327.43, z=43.92 }
	},
	Garage_Legionbank = {
		GaragePoint = { x= 100.9, y= -1073.35, z= 29.37 },
		SpawnPoint = { x= 130.25, y= -1075.55, z= 27.92,  h = 92.16 },
		DeletePoint = { x= 129.65, y= -1062.4, z= 27.92 }
	},
	Garage_Casino = {
		GaragePoint = { x= 934.95, y= -1.39, z= 78.76 },
		SpawnPoint = { x= 934.95, y= -1.39, z= 77.76, h = 146.37 },
		DeletePoint = { x= 915.77, y= -32.0, z= 77.76 }
	},
	Garage_Prison = {
	...
	Garage_Beach = {
		GaragePoint = { x= -2029.1, y=-464.05, z=11.46 },
		SpawnPoint = { x=-2046.75, y=-463.25, z=10.44, h = 314.75 },
		DeletePoint = { x=-2025.89, y=-479.79, z=10.47 }
	}
}
...
Config.AircraftPounds = {
	Pound_LSAirport = {
		PoundPoint = {  },
		SpawnPoint = { x = -1096.07, y = -832.18, z = 37.7, h = 92.6 }
	}
}
